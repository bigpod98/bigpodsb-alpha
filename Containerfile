...
RUN rpm-ostree install code chromium fish iotop plasma-workspace-wallpapers qemu qemu-user-static qemu-user-binfmt virt-manager libvirt qemu qemu-user-static qemu-user-binfmt
