...
RUN rpm-ostree install qemu qemu-user-static qemu-user-binfmt virt-manager libvirt qemu qemu-user-static qemu-user-binfmt edk2-ovmf docker-ce docker-ce-cli 
...
RUN rpm-ostree install dconf-editor mediawriter vlc ceph-common python3-qt5 hplip-gui flatpak-builder neofetch code-insiders gnome-console azure-cli devpod
RUN rpm-ostree install lxc-libs rpmdevtools squashfs-tools incus incus-agent kde-connect git-filter-repo git-subtree docker-buildx-plugin docker-compose-plugin
